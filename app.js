...
function buildPortableReportHtml(options={}){
 ...
 const reportMotifs=S.motifs.filter(m=>m.Actif!==false&&selectedMotifs.has(String(m.Code||""))).map(m=>({code:String(m.Code||""),label:String(m.Libelle||m.Code||""),presence:num(m.Presence_Equivalent),absence:num(m.Absence_Equivalent)}));
