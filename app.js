...
function generateHtmlReport(){
 ...
 const html=buildPortableReportHtml({includeAlerts:true,includeChart:true,preview:true});if(!html)return;
...
function buildPortableReportHtml(options={}){
 ...
 const includeAlerts=options.includeAlerts!==undefined?!!options.includeAlerts:($("reportIncludeAlerts")?.checked!==false);
 const includeChart=options.includeChart!==undefined?!!options.includeChart:($("reportIncludeChart")?.checked!==false);
