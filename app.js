...
/* V6.34 — rapport HTML imprimable par équipe et période */
...
function generateHtmlReport(){
 ...
 const w=window.open("","_blank");if(!w)return notify("Autorisez les fenêtres contextuelles pour générer le rapport.");w.document.open();w.document.write(html);w.document.close();
}
